...
import com.example.quickcart.databinding.ItemViewOrdersBinding
import com.example.quickcart.models.OrderItems
...
class AdapterOrders(
    ...
    private val diffUtil = object : DiffUtil.ItemCallback<OrderItems>() {
...
//                    tvOrderStatus.setBackgroundColor(R.color.diya)
                    tvOrderStatus.backgroundTintList =
                        ContextCompat.getColorStateList(context, R.color.diyaGrey)
