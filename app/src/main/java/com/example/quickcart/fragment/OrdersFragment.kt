...
import com.example.quickcart.adapters.AdapterOrders
import com.example.quickcart.databinding.FragmentOrdersBinding
...
class OrdersFragment : Fragment() {
    ...
    private fun onOrderItemViewClicked(orderItems: OrderItems) {
        val bundle = Bundle()
